...
SCARA_Standard.plot(traj9.q,limits = [x1, x2, y1, y2, z1, z2], movie = 'SCARA_St_9.gif')
SCARA_Standard.plot(traj10.q,limits = [x1, x2, y1, y2, z1, z2], movie = 'SCARA_St_10.gif')
SCARA_Standard.plot(traj11.q,limits = [x1, x2, y1, y2, z1, z2], movie = 'SCARA_St_11.gif')
SCARA_Standard.plot(traj12.q,limits = [x1, x2, y1, y2, z1, z2], movie = 'SCARA_St_12.gif',block= True)
